...
namespace MathDotSqrt.Sqrt3D.RenderEngine.Shader {
	...
	public class SpecularShader : ShaderProgram {
		private const string SHADER_PATH = @"specularShader\";
		private const string VERTEX_SHADER = SHADER_PATH + @"specularVertexShader.vs";
		private const string FRAGMENT_SHADER = SHADER_PATH + @"specularFragmentShader.fs";

		public SpecularShader() : base(VERTEX_SHADER, FRAGMENT_SHADER) {
